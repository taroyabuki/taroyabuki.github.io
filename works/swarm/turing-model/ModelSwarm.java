...
public class ModelSwarm extends SwarmImpl{
	...
	public Object buildObjects(){
		...
		for (int i=0; i<width; i++){
			aCell=new Cell(this,i,patternSpace);
	...
	public Object buildActions(){
		...
		try{
			modelActions.createActionForEach$message(cellVector,
				new Selector(Class.forName("Cell"),"step1",false));
			modelActions.createActionForEach$message(cellVector,
				new Selector(Class.forName("Cell"),"step2",false));
			modelActions.createActionForEach$message(cellVector,
				new Selector(Class.forName("Cell"),"step3",false));
			modelActions.createActionForEach$message(cellVector,
				new Selector(Class.forName("Cell"),"step4",false));
			modelActions.createActionForEach$message(cellVector,
				new Selector(Class.forName("Cell"),"step5",false));
			modelActions.createActionForEach$message(cellVector,
				new Selector(Class.forName("Cell"),"step6",false));
	...
	public void initializeCellVector(){
		...
		if(cellVector!=null){
			for(int i=0;i<width;++i){
				...
				aCell.setParams(ru,rv,w1,w2,m0,m1,p,d,e);
